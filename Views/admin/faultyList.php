  ...
  <div class="w3-row">
	  <div class="w3-ul w3-quarter" id="id01" style="overflow-y:scroll; overflow-x:hidden; height:400px;display:none;">
		<div w3-repeat="result" class="w3-mobile" style="padding:5px;">
		  <div class="w3-bar w3-round-large w3-card w3-button w3-red" onclick="goHistory('{{Name}}','{{Time}}','{{IMEI}}')">
	  ...
	  <div class="w3-threequarter" style="display:none;" id="id03">
		...
		<div class="w3-container">
			<div class="w3-card w3-white w3-margin-bottom w3-row">
				<div class="w3-row w3-color w3-center w3-padding">
			...
			<div class="w3-row">
				<div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-round w3-color" style="width:100%;" onclick='window.location.assign("?item=7")'><i class="fa fa-history"></i> Show Logs</button></div>
				<div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-round w3-color" style="width:100%;" onclick='window.open("https://www.google.com/maps/search/?api=1&query="+locationLatLng, "_blank")'><i class="fa fa-map-marker"></i> Locate</button></div>
				<div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-round w3-color" style="width:100%;" onclick='getImg();'><i class="fa fa-image"></i> Device Image</button></div>
				<div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-round w3-color" style="width:100%;" onclick='window.open("/Controller/download.php?q="+w3.id("log_imei").innerHTML,"_blank");'><i class="fa fa-download"></i> Download</button></div>
			</div>
		</div>
	  </div>
  </div>
