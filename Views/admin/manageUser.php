...
<div class="w3-container w3-margin-bottom">
  <button class="w3-right w3-button w3-color w3-round-large w3-margin-top" onclick="w3.show('#addUser')">Add Users</button>
  <h2>Users</h2>
  
  <div class="w3-animate-top w3-section w3-border w3-round-xlarge w3-white w3-text-color" style="display:none;" id="addUser">
	<div class="w3-row" id="id02">
		...
		<div class="w3-col s12 m6 l3 inputPadding" w3-repeat="result">
			<label>{{Title}} :</label>
			<input class="w3-input w3-border w3-round" id="{{ID}}" type="{{Type}}">
		</div>
		<div class="w3-col s12 m6 l3" w3-repeat="select">
			<div style="display:{{View}}" class="inputPadding">
				<label>{{Title}} :</label>
				<select class="w3-input w3-border w3-round" id="{{ID}}" title="{{Branch}}"></select>
			</div>
		</div>
	...
	<div class="w3-row" style="margin:10px">
		<button class="w3-col s12 m12 l12 w3-button w3-color w3-round" id="addUserBtn" onclick="addUser()">Add User</button>
	</div>
  </div>
  
  <h3>Users List</h3>
  <ul class="w3-ul" id="id01">
    <li class="w3-bar w3-round-xlarge w3-card w3-button" w3-repeat="result" onclick="listUser('{{Name}}','{{Branch}}')">
