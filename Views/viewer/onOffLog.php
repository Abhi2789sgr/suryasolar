...
<script>
	...
	function onStart() {
		if (localStorage.temp_name != undefined && localStorage.temp_imei != undefined) {
			...
			w3.getHttpObject("../Controller/viewer/getOnOffLog.php?imei=" + imei + '&limit=50&pageNo=' + pageNo, myFunction);
		}
	...
	function downloadCSV() {
		if (localStorage.temp_name != undefined && localStorage.temp_imei != undefined) {
			var name = localStorage.temp_name;
			var imei = localStorage.temp_imei;
			w3.getHttpObject("../Controller/viewer/downloadOnOffLogs.php?imei=" + imei + "&startDate=" + startDate.value + "&endDate=" + endDate.value, myFunction);
		}
